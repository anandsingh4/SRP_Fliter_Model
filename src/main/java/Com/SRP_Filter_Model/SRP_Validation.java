...
public class SRP_Validation {
	...
	//List<String> allowedStatuses = Arrays.asList("immediate", "ready to move", "under construction");
...
//			.basePath(Base_EndPoint.End_Url)
			.queryParams(queryParams).accept(ContentType.JSON)
			.contentType(ContentType.JSON).header("User-Agent", "PostmanRuntime/7.6.0")
			.header("Cookie",
